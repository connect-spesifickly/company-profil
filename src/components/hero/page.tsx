  ...
  return (
    <div>
      <div
        ...
        style={{
          backgroundImage:
            "url(https://assets.new.siemens.com/siemens/assets/api/uuid:88bfd937-4ce9-46db-93e1-37f3785535fb/width:750/quality:high/SIE-Santa-Digital-Twin-VR-16x9-Header-AI-generated.webp)",
        }}
      >
